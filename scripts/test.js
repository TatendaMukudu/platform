...
const SUITES = [
  ...
  'notes-http-smoke.js',   // pinned + team-shared notes (HTTP): the author shares/pins; the privacy gate hard-blocks sharing a sensitive note; a shared+pinned note reaches teammates IN SCOPE (a sibling branch never sees it — no leak) via the safe projection; pinning needs visibility; un-sharing takes team visibility back
