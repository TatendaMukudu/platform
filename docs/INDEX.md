...
| **What has the founder decided?** | `ttd/founder-decisions-2026-08.md` — **binding, 44 decisions, indexed at the top.** Read the index, then only what your task touches. This is the store: nothing in it should ever be re-derived or re-asked |
...
**Forty-four have been taken** — see `ttd/founder-decisions-2026-08.md`, indexed at the top.
